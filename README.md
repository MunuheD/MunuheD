...
- **[Retail-Data-Warehouse-ETL](https://github.com/MunuheD/DATA-WAREHOUSING)**: This project implements an ETL pipeline and data warehouse for retail and e-commerce datasets using Python and SQLite, extracting, cleaning, and transforming data from multiple sources, then loading it into an Inmon-modeled database with OLAP operations and visualizations for actionable insights.
